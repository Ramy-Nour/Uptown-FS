...
// NOTE: this route must be defined BEFORE the generic /payment-plans/:id route so that
// Express does not treat "approved-for-unit" as an :id parameter.
router.get(
...
// NOTE: more specific payment-plan routes (e.g. /my, /team, /approved-for-unit) must be
// defined BEFORE this generic :id route to avoid Express capturing them here.
router.get(
  '/payment-plans/:id',
  authMiddleware,
  requireRole(['property_consultant', 'financial_manager', 'financial_admin', 'sales_manager', 'admin', 'superadmin']),
