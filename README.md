...
- [2025-12-04 00:30] Documents router parse error removed; single clean ES module restored
  ...
  - Tests: Extended src/app.int.test.js to hit /api/documents/client-offer and /api/documents/reservation-form (unauthenticated 401 smoke checks) so any future syntax/route wiring errors in api/src/documentsRoutes.js will show up in the existing `npm run test:integration` flow.
