...
router.post(
  ...
  async (req, res) => {
    ...
    try {
      ...
      // Find latest approved plan for this unit (by unit_id or unit_code in snapshot)
      // Be tolerant of whitespace or string types in snapshots by trimming before checks.
